...
import { attendanceTabButtons } from "@/assets/data/attendanceSeed";
...
const AttendanceTabs = () => {
  ...
  return (
    <div
      ...
      ref={tabsRef}>
      {attendanceTabButtons.map((t) => (
        <button
          key={t.id}
          type="button"
          id={t.id}
          role="tab"
          className={`attendance-tab${activeTab === t.tab ? " is-active" : ""}`}
      ...
      <span
        className="attendance-tab-indicator"
        aria-hidden="true"
        ref={indicatorRef}
      />
    </div>
